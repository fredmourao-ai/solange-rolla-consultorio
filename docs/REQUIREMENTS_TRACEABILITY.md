...
|---|---|---|---:|---|---|
| R001 | Cadastro de usuários | Admin | 0 | A01–A04 | planned |
| R002 | Perfil-base + permissão individual por rotina | Admin | 0 | A04–A10 | planned |
| R003 | `deny` explícito prevalece | Admin | 0 | A05 | planned |
| R004 | Usuário inativo perde acesso | Admin | 0 | A11/Q02 | planned |
| R005 | Secretaria/Contabilidade nunca obtêm clínica por checkbox | Segurança | 0 | A07/P12 | planned |
| R006 | Alteração de permissão auditada | Admin | 0 | A12 | planned |
| R007 | Permissões críticas exigem MFA/AAL2 | Admin | 0 | A01/A12 | planned |
| R008 | Menu respeita permissões | Todos | 0/1 | A08/A10 | planned |
| R009 | Backend/banco respeitam permissões, não só UI | Segurança | 0 | A09/Q01 | planned |
...
| R021 | Agenda Hoje/Dia/Semana/Mês | Todos | 2 | G01 | planned |
| R022 | Nova consulta diretamente da Agenda | Secretaria/Profissional | 2 | G02–G04 | planned |
| R023 | Clique em horário vazio para agendar | Secretaria/Profissional | 2 | G03 | planned |
| R024 | Recorrência semanal/quinzenal/personalizada | Secretaria/Profissional | 2 | G05 | planned |
| R025 | Alterar uma ocorrência sem destruir série | Secretaria/Profissional | 2 | G06 | planned |
| R026 | Reagendamento preserva histórico | Secretaria/Profissional | 2 | G06 | planned |
| R027 | Bloqueio de horários/folga/férias | Secretaria/Profissional | 2 | G07 | planned |
| R028 | Conflito bloqueado no servidor/banco | Segurança/Agenda | 2 | G08 | planned |
| R029 | Confirmação de consulta | Secretaria/Paciente | 2 | G09 | planned |
| R030 | Check-in `Paciente chegou` | Secretaria | 2 | G10/H01 | planned |
| R031 | Estados da agenda em linguagem humana | Todos | 2 | G12 | planned |
| R032 | Nenhum UUID exigido em rotina de agenda | Todos | 2 | G13 | planned |
...
| R069 | Dados sintéticos em testes/homologação | Segurança | todas | Q10 + revisão | planned |
| R070 | Migrations forward-only | Arquitetura | todas | Q08/Q09 | planned |
