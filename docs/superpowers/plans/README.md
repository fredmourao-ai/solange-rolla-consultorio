...
A arquitetura v2 aprovada em 2026-08-24 deve ser executada a partir de:

- `2026-08-24-00-execution-index.md`

O índice define ordem, paralelismo, gates e dependências entre os subplanos.
...
`2026-08-24-solange-rolla-consultorio-implementation.md` é **v1 / superseded**. Ele foi escrito antes da aprovação da arquitetura multiagente v2 e não deve ser executado. Em qualquer conflito, prevalecem `AGENTS.md`, `docs/ARCHITECTURE.md`, ADRs e os planos v2 listados acima.
