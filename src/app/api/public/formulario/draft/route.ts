...
import { savePublicIntakeDraft } from '@/modules/forms/application/public-intake-actions'
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return NextResponse.redirect(canonicalCapabilityDestination('/formulario?salvo=1', appUrl), 303)
  } catch {
    return NextResponse.redirect(canonicalCapabilityDestination('/formulario?erro=1', appUrl), 303)
  }
}
