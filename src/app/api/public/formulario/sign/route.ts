...
import { recordLegalAcceptance } from '@/modules/forms/application/accept-legal-document'
import { signPublicSubmission } from '@/modules/signatures/application/public-signature'
