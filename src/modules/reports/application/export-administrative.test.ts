...
describe('administrative exports',()=>{
 ...
 it('neutralizes spreadsheet formulas in text cells',()=>{const text=new TextDecoder().decode(buildAdministrativeCsv([{...rows[0],descricao:'=HYPERLINK("https://invalid.example")'}]));expect(text).toContain("'=HYPERLINK")})
