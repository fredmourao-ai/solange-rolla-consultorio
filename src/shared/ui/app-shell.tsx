...
export function AppShell({ children, role = 'staff' }: { children: ReactNode; role?: string }) {
  ...
  return <div className="app-shell">
    <aside className="app-shell__sidebar">
      <a className="app-shell__brand" href="/dashboard" aria-label="Solange Rolla - Dashboard"><Image className="brand-logo" src="/brand/solange-rolla-logo.png" alt="" width={245} height={60} priority /></a>
