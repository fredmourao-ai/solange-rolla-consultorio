...
select ok((select polqual::text like '%psychologist_owner%' and polqual::text like '%aal2%' from pg_policies where schemaname = 'storage' and tablename = 'objects' and policyname = 'private_storage_select_clinical_owner_aal2'), 'clinical policy requires owner and AAL2');
