...
// Stateful staging workflows are pinned when they need access to persisted homologation
// state; staging-promote has a shared canonical gate before its host-pinned promote job.
